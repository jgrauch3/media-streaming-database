...
## Overview
This project involves the end-to-end design and implementation of a relational database for a media streaming platform (similar to Spotify/Netflix). [cite_start]The system manages complex interactions between **Users, Creators, Listeners, and Content**
